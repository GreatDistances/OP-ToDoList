...
const displayListItemsFromArr = (array) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    const createSelectListId = (text, container, method) => {
      ...
      cell.value = value;
      cell.onchange = () => {
        listManager[method](arr[i].itemId, arr[i].listId, cell.value); // sets value in listManager
      };
      cellContainer.append(cell, br, label);
      container.append(cellContainer);
    };
